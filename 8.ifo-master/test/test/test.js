...
before(async function(){
    ...
    offerToken = await DealToken.deploy(`Offer token`, `OTK`, expandTo18Decimals(1000000));
...
describe(`Check start and finish launchpad`, async function (){
    ...
    it(`Should correct calculate taxes with levels`, async function (){
